...
showfortuneNow(){
    if [ $DEBUG -eq "1" ]; then echo "function showfortuneNow"; fi
    echo '${goto $alignc}${color1}${font1}Fortune'
    echo '${color}${font}${exec cat '$FILENAMEFORTUNE' | fold -w 40 -s}'
    echo '${color}'
    echo ""
}
showweathernow(){
    ...
    echo '${goto $alignc}${color1}${font1}Weather: ${font}${color}'$THISWEATHER
    echo '${color}'
}
events(){
if [ $DEBUG -eq "1" ]; then echo "function events"; fi
if [ -e $EVENT1 ]; then
    echo '${color3}${voffset 5}${font1}Event 1'
    echo '${color}${voffset -3}${font}${exec  cat '$EVENT1' | fold -w 40 -s}'
    if [ -e $EVENT2 ]; then
        echo '${color3}${voffset 5}${font1}Event 2'
        echo '${color}${voffset -3}${font}${exec cat '$EVENT2' | fold -w 40 -s}'
    fi
    echo '${color}'
fi
}
notes(){
if [ $DEBUG -eq "1" ]; then echo "function notes"; fi
if [  -e $NOTE1 ]; then
    echo '${color4}${voffset 5}${font1}Note 1'
    echo '${color}${voffset -3}${font}${exec cat '$NOTE1' | fold -w 40 -s}'
    if [ -e $NOTE2 ]; then
        echo '${color4}${voffset 5}${font1}Note 2'
        echo '${color}${voffset -3}${font}${exec cat '$NOTE2' | fold -w 40 -s}'
    fi
    echo '${color}'
fi
}
tasks(){
if [ $DEBUG -eq "1" ]; then echo "function tasks"; fi
if [  -e  $TASK1 ]; then
    echo '${color5}${voffset 5}${font1}Task 1'
    echo '${color}${voffset -3}${font2}${exec cat '$TASK1' | fold -w 40 -s}'
    if [ -e $TASK2 ]; then
        echo '${color5}${voffset 5}${font1}Task 2'
        echo '${color}${voffset -3}${font}${exec cat '$TASK2' | fold -w 40 -s}'
    fi
    if [ -e $TASK3 ]; then
        echo '${color5}${voffset 5}${font1}Task 3'
        echo '${color}${voffset -3}${font}${exec cat '$TASK3' | fold -w 40 -s}'
    fi
    if [ -e $TASK4 ]; then
        echo '${color5}${voffset 5}${font1}Task 4'
        echo '${color}${voffset -3}${font}${exec cat '$TASK4' | fold -w 40 -s}'
    fi
     if [ -e $TASK5 ]; then
        echo '${color5}${voffset 5}${font1}Task 5'
        echo '${color}${voffset -3}${font}${exec cat '$TASK5' | fold -w 40 -s}'
    fi
    echo '${color}'
fi
}
