...
showfortuneNow(){
    SHOWENDING=1
    echo '${color6}${voffset -2}${font Roboto:size=8}Fortune'
    echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$FILENAMEFORTUNE' | fold -w 40 -s}'
    echo '${color}'
}
showweathernow(){
    local THISWEATHER;
...
events(){
    if [  -e $EVENT1  ]; then
        SHOWENDING=1
        echo '${color6}${voffset -2}${font Roboto:size=8}Event 1'
        echo '${color4}${voffset -2}${font Roboto:size=8}${exec  cat '$EVENT1' | fold -w 40 -s}'
        if [ -e $EVENT2 ]; then
            echo '${color6}${voffset -2}${font Roboto:size=8}Event 2'
            echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$EVENT2' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
notes(){
    if [  -e $NOTE1  ]; then
        SHOWENDING=1
        echo '${color7}${voffset -2}${font Roboto:size=8}Note 1'
        echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$NOTE1' | fold -w 40 -s}'
        if [ -e $NOTE2 ]; then
            echo '${color7}${voffset -2}${font Roboto:size=8}Note 2'
            echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$NOTE2' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
tasks(){
    if [  -e $TASK1  ]; then
        SHOWENDING=1
        echo '${color8}${voffset -2}${font Roboto:size=8}Task 1'
        echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$TASK1' | fold -w 40 -s}'
        if [ -e $TASK2 ]; then
            echo '${color8}${voffset -2}${font Roboto:size=8}Task 2'
            echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$TASK2' | fold -w 40 -s}'
        fi
        if [ -e $TASK3 ]; then
            echo '${color8}${voffset -2}${font Roboto:size=8}Task 3'
            echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$TASK3' | fold -w 40 -s}'
        fi
        if [ -e $TASK4 ]; then
            echo '${color8}${voffset -2}${font Roboto:size=8}Task 4'
            echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$TASK4' | fold -w 40 -s}'
        fi
        if [ -e $TASK5 ]; then
            echo '${color8}${voffset -2}${font Roboto:size=8}Task 5'
            echo '${color4}${voffset -2}${font Roboto:size=8}${exec cat '$TASK5' | fold -w 40 -s}'
        fi
    fi
}
ending()
