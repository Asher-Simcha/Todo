...
{
    SHOWENDING=1
    echo '${color7}${voffset 2}${font Roboto-Light:bold:pixelsize=12}FORTUNE'
...
showweathernow(){
    ...
    echo '${color7}${voffset 2}${font Roboto-Light:bold:pixelsize=12}WEATHER'
...
events()
{
    if [  -e  $EVENT1 ]; then
        SHOWENDING=1
        echo '${color7}${voffset 2}${font Roboto-Light:bold:pixelsize=12}Event 1'
        echo '${color5}${voffset 1}${font Roboto-Light:bold:pixelsize=12}${exec  cat '$EVENT1' | fold -w 40 -s}'
        if [ -e $EVENT2 ]; then
            echo '${color7}${voffset 2}${font Roboto-Light:bold:pixelsize=12}Event 2'
...
notes()
{
    if [  -e  $NOTE1 ]; then
        SHOWENDING=1
        echo '${color8}${voffset 2}${font Roboto-Light:bold:pixelsize=12}Note 1'
        echo '${color5}${voffset 1}${font Roboto-Light:bold:pixelsize=12}${exec cat '$NOTE1' | fold -w 40 -s}'
        if [ -e $NOTE2 ]; then
            echo '${color8}${voffset 2}${font Roboto-Light:bold:pixelsize=12}Note 2'
