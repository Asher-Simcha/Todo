...
showfortuneNow(){
    SHOWENDING=1
    echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}FORTUNE'
    echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$FILENAMEFORTUNE' | fold -w 40 -s}'
    echo '${color}'
}
showweathernow(){
    local THISWEATHER;
    ...
    echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}WEATHER'
    echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}'$THISWEATHER
    echo '${color}'
}
events(){
    if [  -e  $EVENT1 ]; then
        SHOWENDING=1
        echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Event 1'
        echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec  cat '$EVENT1' | fold -w 40 -s}'
        if [ -e $EVENT2 ]; then
            echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Event 2'
            echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$EVENT2' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
notes(){
    if [  -e  $NOTE1 ]; then
        SHOWENDING=1
        echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Note 1'
        echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$NOTE1' | fold -w 40 -s}'
        if [ -e $NOTE2 ]; then
            echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Note 2'
            echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$NOTE2' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
tasks(){
    if [  -e  $TASK1 ]; then
        SHOWENDING=1
        echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Task 1'
        echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$TASK1' | fold -w 40 -s}'
        if [ -e $TASK2 ]; then
            echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Task 2'
            echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$TASK2' | fold -w 40 -s}'
        fi
        if [ -e $TASK3 ]; then
            echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Task 3'
            echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$TASK3' | fold -w 40 -s}'
        fi
        if [ -e $TASK4 ]; then
            echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Task 4'
            echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$TASK4' | fold -w 40 -s}'
        fi
        if [ -e $TASK5 ]; then
            echo '${color4}${voffset 5}${font Feena Casual:pixelsize=20}Task 5'
            echo '${color5}${voffset -3}${font Roboto-Light:pixelsize=12}${exec cat '$TASK5' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
