...
{
    SHOWENDING=1
    echo '${voffset 5}${color3}${font sesame:bold:pixelsize=15}FORTUNE'
    echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$FILENAMEFORTUNE' | fold -w 40 -s}'
    echo '${color}'
}
showweathernow(){
    local THISWEATHER;
    ...
    echo '${voffset 5}${color3}${font sesame:bold:pixelsize=15}WEATHER'
    echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}'$THISWEATHER
    echo '${color}'
}
events()
{
    if [  -e  $EVENT1 ]; then
        SHOWENDING=1
        echo '${color3}${voffset 5}${font sesame:bold:pixelsize=15}Event 1'
        echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec  cat '$EVENT1' | fold -w 40 -s}'
        if [ -e $EVENT2 ]; then
            echo '${color3}${voffset 5}${font sesame:bold:pixelsize=15}Event 2'
            echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$EVENT2' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
notes()
{
    if [  -e  $NOTE1 ]; then
        SHOWENDING=1
        echo '${color4}${voffset 5}${font sesame:bold:pixelsize=15}Note 1'
        echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$NOTE1' | fold -w 40 -s}'
        if [ -e $NOTE2 ]; then
            echo '${color4}${voffset 5}${font sesame:bold:pixelsize=15}Note 2'
            
            echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$NOTE2' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
tasks()
{
    if [  -e  $TASK1 ]; then
        SHOWENDING=1
        echo '${color5}${voffset 5}${font sesame:bold:pixelsize=15}Task 1'
        echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$TASK1' | fold -w 40 -s}'
        if [ -e $TASK2 ]; then
            echo '${color5}${voffset 5}${font sesame:bold:pixelsize=15}Task 2'
            echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$TASK2' | fold -w 40 -s}'
        fi
        if [ -e $TASK3 ]; then
            echo '${color5}${voffset 5}${font sesame:bold:pixelsize=15}Task 3'
            echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$TASK3' | fold -w 40 -s}'
        fi
        if [ -e $TASK4 ]; then
            echo '${color5}${voffset 5}${font sesame:bold:pixelsize=15}Task 4'
            echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$TASK4' | fold -w 40 -s}'
        fi
        if [ -e $TASK5 ]; then
            echo '${color5}${voffset 5}${font sesame:bold:pixelsize=15}Task 5'
            echo '${color2}${voffset -3}${font sesame:bold:pixelsize=13}${exec cat '$TASK5' | fold -w 40 -s}'
        fi
        echo '${color}'
    fi
}
