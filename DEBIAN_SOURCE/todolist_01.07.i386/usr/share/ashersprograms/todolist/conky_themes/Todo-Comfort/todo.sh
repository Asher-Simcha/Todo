...
showweathernow(){
    ...
    echo '${color2}${font1}Weather ${font}${color1}'$THISWEATHER
}
events(){
if [ $DEBUG -eq "1" ]; then echo "function events"; fi
if [ -e $EVENT1 ]; then
    echo '${color2}${voffset 5}${font1}Event 1'
    echo '${color1}${voffset -3}${font}${exec  cat '$EVENT1' | fold -w 40 -s}'
    if [ -e $EVENT2 ]; then
        echo '${color2}${voffset 5}${font1}Event 2'
...
if [  -e $NOTE1 ]; then
    echo '${color2}${voffset 5}${font1}Note 1'
    echo '${color1}${voffset -3}${font}${exec cat '$NOTE1' | fold -w 40 -s}'
    if [ -e $NOTE2 ]; then
        echo '${color2}${voffset 5}${font1}Note 2'
...
if [  -e  $TASK1 ]; then
    echo '${color2}${voffset 5}${font1}Task 1'
    echo '${color1}${voffset -3}${font2}${exec cat '$TASK1' | fold -w 40 -s}'
    if [ -e $TASK2 ]; then
        echo '${color2}${voffset 5}${font1}Task 2'
        echo '${color1}${voffset -3}${font}${exec cat '$TASK2' | fold -w 40 -s}'
    fi
    if [ -e $TASK3 ]; then
        echo '${color2}${voffset 5}${font1}Task 3'
        echo '${color1}${voffset -3}${font}${exec cat '$TASK3' | fold -w 40 -s}'
    fi
    if [ -e $TASK4 ]; then
        echo '${color2}${voffset 5}${font1}Task 4'
        echo '${color1}${voffset -3}${font}${exec cat '$TASK4' | fold -w 40 -s}'
    fi
     if [ -e $TASK5 ]; then
        echo '${color2}${voffset 5}${font1}Task 5'
