...
showfortuneNow(){
    SHOWENDING=1
    echo '${color5}${voffset 5}${font Noto Sans:size=11}FORTUNE'
    echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$FILENAMEFORTUNE' | fold -w 40 -s}'
    echo '${color}'
}
showweathernow(){
    local THISWEATHER;
    ...
    echo '${goto 188}${color0}${voffset -12}${font1}'$THISWEATHER
}
events(){
    if [  -e  $EVENT1 ]; then
        SHOWENDING=1
        echo '${color5}${voffset 5}${font Noto Sans:size=11}Event 1'
        echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec  cat '$EVENT1' | fold -w 40 -s}'
        if [ -e $EVENT2 ]; then
            echo '${color5}${voffset 5}${font Noto Sans:size=11}Event 2'
            echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$EVENT2' | fold -w 40 -s}'
        fi
    fi
}
notes(){
    if [  -e  $NOTE1 ]; then
        SHOWENDING=1
        echo '${color6}${voffset 5}${font Noto Sans:size=11}Note 1'
        echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$NOTE1' | fold -w 40 -s}'
        if [ -e $NOTE2 ]; then
            echo '${color6}${voffset 5}${font Noto Sans:size=11}Note 2'
            echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$NOTE2' | fold -w 40 -s}'
        fi
    fi
}
tasks(){
    if [  -e $TASK1  ]; then
        SHOWENDING=1
        echo '${color7}${voffset 5}${font Noto Sans:size=11}Task 1'
        echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$TASK1' | fold -w 40 -s}'
        if [ -e $TASK2 ]; then
            echo '${color7}${voffset 5}${font Noto Sans:size=11}Task 2'
            echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$TASK2' | fold -w 40 -s}'
        fi
        if [ -e $TASK3 ]; then
            echo '${color7}${voffset 5}${font Noto Sans:size=11}Task 3'
            echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$TASK3' | fold -w 40 -s}'
        fi
        if [ -e $TASK4 ]; then
            echo '${color7}${voffset 5}${font Noto Sans:size=11}Task 4'
            echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$TASK4' | fold -w 40 -s}'
        fi
        if [ -e $TASK5 ]; then
            echo '${color7}${voffset 5}${font Noto Sans:size=11}Task 5'
            echo '${color3}${voffset -3}${font Noto Sans:size=11}${exec cat '$TASK5' | fold -w 40 -s}'
        fi
    fi
}
displayheader(){
